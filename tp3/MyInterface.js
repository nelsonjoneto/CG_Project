...
export class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        // Add slider for global ambient light intensity
        this.gui.add(this.scene, 'ambientIntensity', 0.0, 1.0).name('Ambient Intensity').onChange(this.scene.updateAmbientLight.bind(this.scene));

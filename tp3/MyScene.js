...
import { MyCylinder } from "./MyCyllinder.js";
...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.cyllinder = new MyCylinder(this, 8, 20);
        
        this.objects = [this.plane, this.pyramid, this.cone, this.tangram, this.unitCube, this.prism, this.cyllinder];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Plane': 0 , 'Pyramid': 1, 'Cone': 2, 'Tangram' : 3, 'UnitCube' : 4, 'Prism' : 5, 'Cyllinder' : 6};
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.5, 0.3, 0.1, 1);
        this.material4.setDiffuse(0.6, 0.4, 0.2, 1);  
        this.material4.setSpecular(0.2, 0.1, 0.05, 1); 

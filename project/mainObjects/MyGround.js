...
/**
 * MyGround - Creates terrain with water features using shaders
 * @constructor
 * @param scene    - Reference to MyScene object
 * @param textures - Object containing required textures (grass, water, mask)
 */
export class MyGround extends CGFobject {
    ...
    /**
     * Load lake mask image data for collision detection
     * Creates a canvas to extract pixel data from the mask image
     */
    loadLakeMaskData() {
        const img = new Image();
    ...
    /**
     * Check if a world position is over a lake
     * Uses the mask texture to determine water vs. land
     * @param x - World X coordinate
     * @param z - World Z coordinate
     * @return {boolean} True if position is over water
     */
    isLake(x, z) {
    ...
    /**
     * Check if a position is within radius distance of water
     * Samples multiple points in a circle around the position
     * @param x      - World X coordinate
     * @param z      - World Z coordinate
     * @param radius - Check radius (default: 3)
     * @return {boolean} True if position is near water
     */
    ...
    /**
     * Display the ground with shader effects
     * Uses custom shader for blending grass and water textures
     */
    display() {
